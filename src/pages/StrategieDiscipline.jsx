...
const ICT_LONDON_STEPS = [
  ...
  { step: 4, label: "FVG",            color: "#00ff88", icon: "📦", desc: "Attendre le retracement dans le Fair Value Gap. Pas d'entrée au hasard sur le move.", critical: false },
  ...
  return (
    <div style={{ padding: '24px 28px', maxWidth: '1000px', fontFamily: "'JetBrains Mono','Fira Code',monospace" }}>
      <div style={{ marginBottom: '24px' }}>
        <div style={{ fontSize: '10px', color: '#3a6a4a', letterSpacing: '3px', marginBottom: '4px' }}>SESSIONS ICT</div>
        <h1 style={{ fontSize: '22px', fontWeight: '700', color: '#e8f8e8', margin: '0 0 4px' }}>Stratégie et Discipline</h1>
        <div style={{ fontSize: '11px', color: '#3a6a4a' }}>Sessions de trading · Modèles d'entrée ICT · Routines</div>
      </div>
